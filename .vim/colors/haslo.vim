...
call s:SetHi("IncSearch"                 , s:hasloBlack       , s:hasloGrey3           , "none")
call s:SetHi("Search"                    , s:hasloSteel       , s:hasloGrey1           , "underline")
...
call s:SetHi("Visual"                    , s:hasloBackground  , s:hasloGrey2           , "none")
...
call s:SetHi("Identifier"                , s:hasloOrange      , s:hasloBackground      , "none")
call s:SetHi("Keyword"                   , s:hasloRed         , s:hasloBackground      , "none")
call s:SetHi("Label"                     , s:hasloGreen       , s:hasloBackground      , "none")
...
call s:SetHi("PreProc"                   , s:hasloGreen       , s:hasloBackground      , "none")
call s:SetHi("Special"                   , s:hasloViolet      , s:hasloBackground      , "none")
call s:SetHi("SpecialKey"                , s:hasloCyan        , s:hasloBackground      , "none")
call s:SetHi("Statement"                 , s:hasloBlue        , s:hasloBackground      , "none")
call s:SetHi("StorageClass"              , s:hasloOrange      , s:hasloBackground      , "none")
...
" JSON
call s:SetHi("jsonKeyword"               , s:hasloRed         , s:hasloBackground      , "none")
