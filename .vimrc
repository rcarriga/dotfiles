...
if dein#load_state('~/.cache/dein')
  call dein#begin('~/.cache/dein')
    ...
    call dein#add('roxma/nvim-yarp', {'on_event': 'InsertEnter'})
    call dein#add('roxma/vim-hug-neovim-rpc', {'on_event': 'InsertEnter'})
...
function! GetTestResults() abort
    if get(b:, "test_status_total")
        return b:test_status_passed."/".b:test_status_total
    endif
    return ""
endfunction
" ###################################################################################
