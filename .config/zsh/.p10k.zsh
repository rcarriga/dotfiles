# Generated by Powerlevel10k configuration wizard on 2020-01-15 at 22:02 GMT.
...
# no frame, lightest, compact, many icons, concise, transient_prompt,
# instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=1
