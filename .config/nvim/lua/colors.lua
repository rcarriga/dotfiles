...
loadHighlights(
  {
    ...
    BufferCurrentMod = {Normal, "underline"},
    BufferCurrentSign = {Info},
    BufferCurrentTarget = {Error, "bold"},
    BufferVisible = {Normal, "bold"},
    BufferVisibleMod = {Normal, "bold,underline"},
    BufferVisibleSign = {Info},
    BufferVisibleTarget = {Error, "bold,underline"},
    BufferInactive = {Grey2},
    BufferInactiveMod = {Grey2, "underline"},
    BufferInactiveSign = {Grey2},
    BufferInactiveTarget = {Error, "bold"},
